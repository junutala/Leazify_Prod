...
const en: Translations = {
  ...
  inv_lease_invoice_title: 'توليد فواتير الإيجار ووديعة الأمان',
  ...
  inv_amc_desc: 'اختر مستوى في هيكل المشروع. سيتم توليد فواتير الصيانة لجميع العقود النشطة التي تحتوي على مبلغ صيانة ولم تُفوتَر بعد.',
  inv_turnover_title: 'توليد فواتير إيجار التبادل',
  inv_turnover_desc: 'اختر الهيكل والشهر، حمِّل قالب CSV مع وحدات المول، أدخل بيانات المبيعات، ارفع وراجع، ثم ولِّد الفواتير للوحدات المختارة.',
  inv_bulk_title: 'إنشاء فواتير جماعي',
  inv_bulk_desc: 'اختر مستوى الهيكل ونوع الاستخدام. أدخل نسب المراجعة لكل عقد، ثم ولِّد الفواتير جماعياً لجميع العقود المعلقة.',
  ...
  inv_empty_desc: 'ولِّد الفواتير باستخدام الألواح على اليسار',
  ...
  inv_turnover_step1: 'اختر وحمِّل',
  inv_turnover_step2: 'ارفع CSV',
  inv_turnover_step3: 'راجع وولِّد',
  inv_month: 'الشهر *',
  inv_year: 'السنة *',
  inv_download_csv: 'تحميل قالب CSV',
  ...
  inv_skip_manual: 'تخطي — أدخل يدوياً',
  ...
  inv_invoiced_badge: 'تم الفوترة',
  inv_approved_badge: 'تمت الموافقة',
  inv_col_lease_no: 'رقم العقد',
  inv_col_current_rent: 'الإيجار الحالي',
  inv_col_rent_rev: 'مراجعة الإيجار %',
  inv_col_new_rent: 'الإيجار الجديد',
  inv_col_current_sd: 'الوديعة الحالية',
  inv_col_sd_rev: 'مراجعة الوديعة %',
  inv_bulk_leases_found: 'عقد (عقود) نشط تم العثور عليه',

  // ── Receipts ──
  rec_title: 'Receipts',
  rec_subtitle: 'تسجيل المدفوعات مقابل الفواتير وتسوية إيصالات الشيكات',
  ...
  rec_paid: 'المدفوع',
  rec_balance: 'الرصيد',
  rec_exceeds_balance: 'يتجاوز الرصيد المتبقي',
  ...
  rec_cheque_recon_desc: 'تتبع وتسوية مدفوعات الشيكات مقابل كشوف الحساب البنكية.',
  ...
  rec_col_recon_action: 'الإجراء',
  rec_reconciled_status: 'تمت التسوية',
  rec_pending_status: 'معلق',
  rec_mark_reconciled: 'تعيين كمُسوَّى',
  ...
  maint_mr_modal_subtitle: 'طلب منطقة مشتركة — مدفوع من المالك',
  ...
  renew_subtitle: 'مراجعة وتعديل الإيجار للوحدات المشغولة. توليد عقود مجددة للموافقة.',
  renew_tab_pending: 'في انتظار الموافقة',
  renew_tab_create: 'إنشاء تجديدات',
  renew_tab_approved: 'تمت الموافقة / الرفض',
  renew_pending_count: 'عقد (عقود) مجدد في انتظار الموافقة',
  ...
  wo_subtitle: 'توليد وإدارة أوامر العمل لمزودي الخدمة',
  wo_new: 'توليد أمر عمل',
  wo_search_placeholder: 'البحث عن أوامر العمل...',
  wo_col_wo_no: 'رقم أمر العمل',
  ...
  wo_empty_desc: 'ولِّد أمر عمل من طلبات الخدمة أو الصيانة الموافق عليها',
  wo_modal_title: 'توليد أمر عمل',
  ...
  wo_payer: 'الدافع',
  wo_instructions: 'تعليمات أخرى',
  wo_instructions_placeholder: 'أي تعليمات خاصة لمزود الخدمة...',
  wo_generate_btn: 'توليد أمر العمل',
  wo_generating_btn: 'جارٍ التوليد...',
  ...
  reports_subtitle: 'توليد وتحميل التقارير التشغيلية بصيغة PDF أو CSV',
  reports_operational: 'التقارير التشغيلية',
  reports_raw_data: 'تقارير البيانات الخام',
  reports_generate_download: 'توليد وتحميل التقارير التشغيلية بصيغة PDF أو CSV',

  // ── Analytics ──
  analytics_title: 'التحليلات',
  analytics_subtitle: 'المقاييس الرئيسية المستخرجة من سجلات التدقيق والعقود والفواتير',
  analytics_user_activity: 'نشاط المستخدمين',
  analytics_user_activity_sub: 'أحداث سجل التدقيق لكل مستخدم ويوم خلال آخر 7 أيام',
  analytics_approval_turnaround: 'أوقات دورة الموافقة',
  analytics_approval_turnaround_sub: 'معدلات الموافقة والرفض المستخرجة من أحداث سجل التدقيق',

  // ── Staff Assignments / Project Assignment ──
  staff_page_title: 'تعيين المشاريع',
  staff_page_subtitle: 'إنشاء الأدوار وإضافة الموظفين وتعيين المشاريع وإدارة ملكية الملاك.',
  ...
  staff_select_project: 'اختر المشروع...',
  staff_select_role: 'اختر الدور...',
  staff_project_required: 'المشروع والدور مطلوبان',

  // ── Audit Log ──
  audit_title: 'سجل التدقيق',
  audit_subtitle: 'تتبع جميع تغييرات الكيانات مع الطوابع الزمنية والمستخدمين والقيم قبل/بعد',
  ...
  bulk_subtitle: 'رفع ملفات CSV لإعداد هيكل العقارات والأشخاص ومزودي الخدمة على نطاق واسع',

  // ── Landlord Dashboard ──
  landlord_title: 'لوحة تحكم المالك',
  landlord_subtitle: 'نظرة عامة على محفظتك والمقاييس الرئيسية',

  // ── Tenant Portal ──
  tenant_title: 'بوابة المستأجر',
  tenant_subtitle: 'عرض عقدك وفواتيرك وتقديم طلبات الخدمة',

  // ── Service Provider Portal ──
  provider_title: 'بوابة مزود الخدمة',
  provider_subtitle: 'تصفح الطلبات المفتوحة وتقديم عروض الأسعار وإدارة أوامر العمل',

  // ── Communications ──
  comms_title: 'المراسلات',
  comms_subtitle: 'إرسال الرسائل والإشعارات للمستأجرين والموظفين',
...
const ar: Translations = {
  ...
  usp_subtitle: 'From fractional ownership structures to Dubai Tenancy Law compliance — تتعامل ليزيفاي مع ما لا تستطيع برامج العقارات العامة التعامل معه.',
  ...
  leasing_subtitle: 'إدارة جميع عقود الإيجار، التجديدات، والتعيينات',
  ...
  leasing_section_property: 'اختيار المشروع',
  leasing_section_tenant: 'تفاصيل المستأجر',
  leasing_section_period: 'فترة العقد',
  leasing_section_financial: 'الشروط المالية',
  leasing_main_tenant: 'المستأجئ الرئيسي',
  leasing_co_tenant: 'المستأجئ المشارك',
  leasing_add_co_tenant: 'إضافة مستأجئ مشارك',
  ...
  leasing_create_btn: 'إنشاء العقد وتوليد العقد',
  ...
  leasing_co_tenant_error: 'الرجاء تحديد شخص لكل مستأجئ مشارك',
  ...
  inv_sidebar_turnover_desc: 'قم بتحميل بيانات المبيعات و توليد فواتير ربح التبادل',
  ...
  inv_hierarchy_label: 'اختر مستوى الترتيب',
  ...
  rec_all_paid_desc: 'لم يتم العثور على فواتير غير مدفوعة أو مدفوعة جزئياً للهوية المحددة',
  ...
  maint_new_sr: 'طلبات الخدمة',
  maint_new_mr: 'طلبات الصيانة',
